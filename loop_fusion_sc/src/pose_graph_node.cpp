...
std::string VINS_RESULT_PATH_BASE;
...
{
    ros::init(argc, argv, "loop_fusion_sc");
    ros::NodeHandle n("~");
    ...
    if(argc != 2)
    {
        printf("please intput: rosrun loop_fusion_sc loop_fusion_node [config file] \n"
               "for example: rosrun loop_fusion_sc loop_fusion_node "
    ...
    std::string pkg_path = ros::package::getPath("loop_fusion_sc");
    ...
    fsSettings["output_path"] >> VINS_RESULT_PATH_BASE;
    fsSettings["save_image"] >> DEBUG_IMAGE;
    fsSettings["switchable_on"] >> SWITCHABLE_ON;
    fsSettings["switchable_gamma"] >> SWITCHABLE_GAMMA;


    LOAD_PREVIOUS_POSE_GRAPH = fsSettings["load_previous_pose_graph"];
    VINS_RESULT_PATH = VINS_RESULT_PATH_BASE + "/vio_loop.csv";
